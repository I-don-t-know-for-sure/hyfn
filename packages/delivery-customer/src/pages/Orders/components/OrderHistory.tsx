import { Badge, Box, Button, Card, Center, Container, Group, Image, Loader, Table, Text } from '@mantine/core';
...
const OrderHistory: React.FC<OrderHistoryProps> = ({}) => {
  const { data: orders, isLoading, isError, error, fetchNextPage } = useGetOrderHistory();
