...
const createlocalCardTransaction = async ({ arg, client }: createLocalCardTransaction) => {
    ...
    console.log('🚀 ~ file: createLocalCardTransaction.js:27 ~ createlocalCardTransaction ~ customerDoc', customerDoc);
    console.log('🚀 ~ file: createLocalCardTransaction.js:27 ~ createlocalCardTransaction ~ customerDoc', customerDoc);
    const customerBalance = customerDoc?.balance || 0.0;
    console.log('🚀 ~ file: createLocalCardTransaction.js:32 ~ createlocalCardTransaction ~ customerBalance', customerBalance);
    ...
    console.log('🚀 ~ file: createLocalCardTransaction.js:32 ~ createlocalCardTransaction ~ amount', amount);
    console.log('🚀 ~ file: createLocalCardTransaction.js:32 ~ createlocalCardTransaction ~ amount', amount);
    if (!amount) {
