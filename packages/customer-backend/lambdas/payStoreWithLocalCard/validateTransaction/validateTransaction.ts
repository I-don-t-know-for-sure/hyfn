...
import { decryptData, findOne, isLocalCardTransactionValidated, updateOne } from 'hyfn-server';
...
export const validateStoreLocalCardTransaction = async ({
  arg,
  client,
}: validateStoreLocalCardTransactionProps) => {
...
export const handler = async (event) => {
  return await mainWrapper({ event, mainFunction: validateStoreLocalCardTransaction });
};
