...
import { imagesBucketStack, kmsStack } from '../resources/resources';
...
export function customerApiStack({ stack }: StackContext) {
    ...
    routes: {
      ...
      'POST /cancelTransaction': {
        function: {
          ...
          handler: pathToLambdas + 'cancelTransaction/cancelTransaction.handler',
        },
      },
      'POST /confirmPickup': {
        function: {
      ...
      'POST /refreshOrderDocument': {
        function: {
          ...
          handler: pathToLambdas + 'refreshOrderDocument/refreshOrderDocument.handler',
        },
      },
      ...
      'POST /validateStoreLocalCardTransaction': {
        function: {
          ...
          handler:
            pathToLambdas + 'payStoreWithLocalCard/validateTransaction/validateTransaction.handler',
        },
      },
      'POST /getTransactionsList': {
        function: {
          ...
          handler:
            pathToLambdas + 'payWithLocalCard/getTransactionsList/getTransactionsList.handler',
        },
      },
      ...
      'POST /createUserDocument': {
        function: {
          ...
          handler: pathToLambdas + 'createUserDocument/createUserDocument.handler',
        },
      },
      ...
      'POST /updateUserDocument': {
        function: {
          ...
          handler: pathToLambdas + 'updateUserDocument/updateUserDocument.handler',
        },
      },
  ...
  stack.addOutputs({
    ...
    apiFunctionsRoleArn: api.getFunction('POST /updateAddresses')?.role?.roleArn || '',
  });
  return { api };
}
