...
export function storeApiStack({ stack }: StackContext) {
  ...
  const api = new Api(stack, 'storeApi', {
    ...
    routes: {
      'POST /getProductsForStore': {
        function: {
          handler: pathToLambdas + 'getProductsForStore/getProductsForStore.handler',
          functionName: 'getProductsForStore' + stack.stage,
        },
      },
      'POST /setProductAsNotFound': {
        function: {
          handler: pathToLambdas + 'setProductAsNotFound/setProductAsNotFound.handler',
        },
      },
      'POST /setProductAsPickedUp': {
        function: {
          handler: pathToLambdas + 'setProductAsPickedUp/setProductAsPickedUp.handler',
        },
      },
      'POST /updateLocalCardSettings': {
        function: {
          handler: pathToLambdas + 'updateLocalCardSettings/updateLocalCardSettings.handler',
        },
      },
      'POST /disableLocalCardAPIKeys': {
        function: {
          handler: pathToLambdas + 'disableLocalCardAPIKeys/disableLocalCardAPIKeys.handler',
        },
      },
      'POST /setOrderAsAccepted': {
        function: {
          handler: pathToLambdas + 'setOrderAsAccepted/setOrderAsAccepted.handler',
        },
      },
      ...
      'POST /addLocalCardPaymentAPIKey': {
        function: {
          handler: pathToLambdas + 'addLocalCardPaymentAPIKey/addLocalCardPaymentAPIKey.handler',
        },
      },
      ...
      'POST /setOrderAsPreparing': {
        function: {
          handler: pathToLambdas + 'setOrderAsPreparing/setOrderAsPreparing.handler',
        },
      },
      ...
      'POST /createLocalCardTransactionForWallet': {
        function: {
          handler: pathToLambdas + 'payWithLocalCard/createLocalCardTransactionForWallet.handler',
        },
      },
      'POST /getProductFromBarcode': {
        function: {
          handler: pathToLambdas + 'getProductFromBarcode/getProductFromBarcode.handler',
        },
      },
      ...
      'POST /createStoreDocument': {
        function: {
          handler: pathToLambdas + 'createStoreDocument/createStoreDocument.handler',
        },
      },
      'POST /createProduct': {
        function: {
      ...
      'POST /updateStoreOwnerInfo': {
        function: {
          handler: pathToLambdas + 'updateStoreOwnerInfo/updateStoreOwnerInfo.handler',
        },
      },
      ...
      'POST /getAllCollections': {
        function: {
          handler: pathToLambdas + 'getAllCollections/getAllCollections.handler',
        },
      },
      'POST /getCollection': {
        function: {
      ...
      'POST /getCollectionsForProduct': {
        function: {
          handler: pathToLambdas + 'getCollectionsForProduct/getCollectionsForProduct.handler',
        },
      },
      'POST /deleteProduct': {
        function: {
      ...
      'POST /updateProductState': {
        function: {
          handler: pathToLambdas + 'updateProductState/updateProductState.handler',
        },
      },
      'POST /openAndCloseStore': {
        function: {
          handler: pathToLambdas + 'openAndCloseStore/openAndCloseStore.handler',
        },
      },
      'POST /updatePaymentSettings': {
        function: {
          handler: pathToLambdas + 'updatePaymentSettings/updatePaymentSettings.handler',
        },
      },
      ...
      'POST /getCollectionProducts': {
        function: {
          handler: pathToLambdas + 'getCollectionProducts/getCollectionProducts.handler',
        },
      },
      'POST /getProductsForCollection': {
        function: {
          handler: pathToLambdas + 'getProductsForCollection/getProductsForCollection.handler',
        },
      },
      'POST /bulkUpdate': {
      ...
      'POST /getProductsForBulkUpdate': {
        function: {
          handler: pathToLambdas + 'getProductsForBulkUpdate/getProductsForBulkUpdate.handler',
        },
      },
  ...
  stack.addOutputs({
    ...
    apiFunctionsRoleArn: api.getFunction('POST /getProductsForBulkUpdate')?.role?.roleArn || '',
  });
  return { api };
}
