export const createPaymentRequestHandler = async ({ arg, client, session, userId, }: MainFunctionProps) => {
    const { amount } = arg[0];
    ...
    console.log('🚀 ~ file: createPaymentRequest.js:26 ~ totalRequestAmount ~ totalRequestAmount', totalRequestAmount);
    ...
    console.log('🚀 ~ file: createPaymentRequest.js:21 ~ mainFunction ~ availableBalance', availableBalance);
    console.log('🚀 ~ file: createPaymentRequest.js:21 ~ mainFunction ~ availableBalance', availableBalance - totalRequestAmount);
...
export const handler = async (event) => {
    return await mainWrapperWithSession({ event, mainFunction: createPaymentRequestHandler });
};
