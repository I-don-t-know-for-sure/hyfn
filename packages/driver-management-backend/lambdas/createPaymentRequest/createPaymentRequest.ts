export const createPaymentRequestHandler = async ({ arg, client, userId }: MainFunctionProps) => {
...
export const handler = async (event) => {
  return await mainWrapper({ event, mainFunction: createPaymentRequestHandler });
};
