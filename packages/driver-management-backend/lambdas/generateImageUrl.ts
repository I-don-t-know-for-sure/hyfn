export const generateImageUrlHandler = async ({ arg, session, client, event, }: MainFunctionProps) => {
    var result;
...
export const handler = async (event) => {
    return await mainWrapper({ event, mainFunction: generateImageUrlHandler });
};
