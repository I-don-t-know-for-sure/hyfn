import { Card, CardSection, Checkbox, Container, Loader, Paper } from '@mantine/core'
...
const OptionsCard: React.FC<OptionsCardProps> = ({ onChangeHandler, productInfo, setProductInfo, isLoading }) => {
  return (
    <Paper
      shadow={'sm'}
      p={'md'}
    ...
    >
      ...
      {productInfo.options.hasOptions && (
        <Options onChangeHandler={onChangeHandler} productInfo={productInfo} setProductInfo={setProductInfo} />
      )}
    </Paper>
  )
}
