import { Box, Card, CardSection, Paper, Select, Skeleton, Text } from '@mantine/core'
...
const MeasurementSystemCard: React.FC<MeasurementSystemCardProps> = ({ onChangeHandler, productInfo, isLoading }) => {
  return (
