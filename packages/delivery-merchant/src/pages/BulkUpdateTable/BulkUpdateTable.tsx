import { Button, Checkbox, Container, Group, MultiSelect, Table, TextInput } from '@mantine/core'
      ...
      <Table>
        ...
        <tbody>
          {Object.keys(tableData).map((productId) => {
            ...
            return <TableRow key={productId} product={product} selectvalue={selectvalue} onChangeHandler={dispatch} />
          })}
        </tbody>
      </Table>
    </>
